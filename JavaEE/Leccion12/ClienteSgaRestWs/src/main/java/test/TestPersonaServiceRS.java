...
public class TestPersonaServiceRS {
    ...
    public static void main(String[] args) {
        //Para pasar autentificacion, si el servidor lo exige
        ...
        nuevaPersona.setEmail("cmiranda4@mail.com"); //El email debe ser único, pues en la base de datos tiene la propiedad UNIQUE
